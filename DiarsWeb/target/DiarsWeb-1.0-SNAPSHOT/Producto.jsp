<%-- 
    Document   : Producto
    Created on : 19-10-2019, 21:22:00
    Author     : Luigi
--%>
...
<body>
  ...
  <div class="container-fluid">
      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="Producto.jsp">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <ul class="nav md-pills nav-justified pills-success ">
          <li class="nav-item border">
            <a class="nav-link  bg-botton active" data-toggle="tab" href="#panel52" role="tab" id="modCatPla1">Producto </a>
          </li>
          <li class="nav-item border">
            <a class="nav-link bg-botton" data-toggle="tab" href="#panel51" role="tab" id="modCatPla2">Buscar Producto</a>
          </li>
        </ul>
        <div class="tab-content pt-2 pl-1" id="pills-tabContent">
          <div class="tab-pane fade show active" id="panel52" role="tabpanel" aria-labelledby="pills-home-tab">
            <form action="" id="formProducto" name="formProducto">
              <div class="container">
                <div class="row">
                  <div class="col-8 grey lighten-5 pb-3">
                    <div class="md-form">
                      <input type="text" name="inputProducto" id="inputProduct" class="form-control">
                      <label for="inputProducto" id="lblProducto">Nombre Producto </label>
                    </div>
                    <div class="md-form">
                      <input type="text" name="inputProducto" id="inputProduct" class="form-control">
                      <label for="inputProducto" id="lblProducto">Stock Minimo </label>
                    </div>
                    <div class="md-form">
                      <input type="text" name="inputProducto" id="inputProduct" class="form-control">
                      <label for="inputProducto" id="lblProducto"> Stock </label>
                    </div>
                    <div class="my-3">
    ...
    <tbody>
      <%
          int numRegistros = daoPro.getProducto().size();
          for (int i = 0; i < numRegistros; i++) {
                String idPro = daoPro.getProducto().get(i).getIdproducto();
                String nomPro = daoPro.getProducto().get(i).getProducto();
                float stoMinPro = daoPro.getProducto().get(i).getStock_min();
                float stoPro = daoPro.getProducto().get(i).getStock_max();
                int estPro = daoPro.getProducto().get(i).getEstado();
                out.println("<tr>");
                out.println("<td scope='row'>"+ i +"</td>");
                out.println("<td id=nom"+ idPro + ">"+ nomPro + "</td>");
                out.println("<td id=stoMin"+ idPro + " class='text-center' >"+ stoMinPro + "</td>");
                out.println("<td id=sto"+ idPro + " class='text-center' >"+ stoPro + "</td>");
                out.println("<td id=est"+ idPro + " class='text-center' >"+ estPro + "</td>");
                out.println("</tr>");
              }
...
<script>
    ...
    function agregarProducto( id){
        ...
        lbl_cat_pla = document.getElementById("lblProducto");
        
        console.log(nom_cat_pla);
        document.formProducto.inputProducto.value = nom_cat_pla;    
