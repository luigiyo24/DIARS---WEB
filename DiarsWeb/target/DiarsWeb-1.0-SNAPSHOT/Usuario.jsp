<%-- 
    Document   : Usuario
    Created on : 15-10-2019, 21:24:30
    Author     : Luigi
--%>
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <ul class="nav md-pills nav-justified pills-success ">
          <li class="nav-item border">
            <a class="nav-link  bg-botton active" data-toggle="tab" href="#panel52" role="tab">Usuario</a>
          </li>
          <li class="nav-item border">
            <a class="nav-link bg-botton" data-toggle="tab" href="#panel51" role="tab">Buscar Usuario</a>
          </li>
        </ul>
                ...
                <div class="row">
                  <div class="col-8 grey lighten-5">
                    <div class="md-form my-5 pb-4">
                      <input type="text" id="inputCategoriaPlato" class="form-control">
                      <label for="inputCategoriaPlato">Usuario</label>
                    </div>
